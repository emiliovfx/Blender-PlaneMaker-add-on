...
def build_body_block_lines(
    ...
    template_path: str = "",          # kept for compatibility, not used here
    ...
    This is an adapter around the original per-body logic so that
    pm_adapter can call it as:

        build_body_block_lines(bodies=bodies, template_path=...)

    and get one big list of lines for all bodies.
    """
    all_lines: List[str] = []
